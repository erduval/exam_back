        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicienId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_InterventionTechniciens", x => new { x.InterventionId, x.TechnicienId });
                    table.ForeignKey(
                        name: "FK_InterventionTechniciens_AspNetUsers_TechnicienId",
                        column: x => x.TechnicienId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InterventionTechniciens_Interventions_InterventionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InterventionTechniciens_TechnicienId",
